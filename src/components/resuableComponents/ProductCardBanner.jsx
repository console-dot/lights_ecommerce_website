      ...
      <div className="w-full h-[150px] md:h-[400px]  ">
        ...
        >
          ...
          <div className="relative w-full h-full flex flex-col justify-center items-center">
            ...
            <div className="w-full h-full  p-4 z-50 flex flex-col items-center justify-center">
            ...
            <p className="text-white italic z-30 text-[10px] sm:text-base text-center p-2 md:pt-7">
