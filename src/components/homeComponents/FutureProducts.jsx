    ...
    <div className="flex justify-center items-center">
      <div className="container  lg:p-10 p-4">
        <div className="xl:px-48 xl:pb-10 flex justify-center items-center text-center flex-col">
          <div class="nine">
            <h1>
             Future Products<span>Tagline Keywords</span>
            </h1>
          </div>
        ...
        <div className="flex justify-center items-center p-10">
          <button className="px-7 py-3 bg-[#fa9105] border-[#fa9105] hover:bg-white hover:text-[#fa9105] font-semibold  border text-white ">
            Veiw All Products
          </button>
        </div>
      </div>
