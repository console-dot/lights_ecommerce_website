        ...
        <div className="container p-5">
          ...
          <div className="flex flex-col md:flex-row py-5 w-full ">
            ...
            <div className="md:w-[40%] w-full flex flex-col">
              <div className="flex justify-center items-center">
                <h1 className="text-white text-3xl font-bold">Infromation :</h1>
              </div>
              <div className="flex flex-col justify-center p-5 ">
                <div className="flex justify-between py-4 border-b font-bold">
                  <h1 className="text-white">Energy:</h1>
                  <h1 className="text-white">200g</h1>
                </div>
                <div className="flex justify-between py-4 border-b font-bold">
                  <h1 className="text-white">Calories:</h1>
                  <h1 className="text-white">520,00 kcal</h1>
                </div>
                <div className="flex justify-between py-4 border-b font-bold">
                  <h1 className="text-white">Total Fat:</h1>
                  <h1 className="text-white">20,00g</h1>
                </div>
                <div className="flex justify-between py-4 border-b font-bold">
                  <h1 className="text-white">Salt:</h1>
                  <h1 className="text-white">40,00 g</h1>
                </div>
                <div className="flex justify-between py-4 border-b font-bold">
                  <h1 className="text-white">Carbohydrates:</h1>
                  <h1 className="text-white">S, M, L, XL</h1>
                </div>
                <div className="flex justify-between py-4  font-bold">
                  <h1 className="text-white">Sugars:</h1>
                  <h1 className="text-white">55,00g</h1>
                </div>
              </div>
            </div>
          </div>
          <div className="py-5 flex justify-start w-full">
          ...
          <div className="w-full pt-5">
            ...
            <input
              ...
              className="input input-bordered text-white input-primary w-full  focus:outline-none rounded-none focus:border-[#414141] border-[#414141] bg-transparent placeholder:text-white"
            />
          </div>
          <div className="w-full pt-5">
            <label
            ...
            <textarea
              className="textarea textarea-success w-full bg-transparent border border-[#414141] focus:border-[#414141] text-white placeholder:text-white min-h-40
          ...
          <div className="flex flex-col md:flex-row w-full justify-start py-5 items-start gap-3  md:items-center">
            <h1 className="md:w-1/4 text-white">
